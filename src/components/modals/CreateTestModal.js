...
class CreateTestModal extends Component {
    ...
    handleTest = (e) => {
        ...
        if (this.checkBtn.context._errors.length === 0) {
            ...
            axios
                .post(TEST_API_URL + "create", testDto, {
                    headers: {
    ...
    render() {
        return (
            <Modal show={this.props.show} onHide={this.handleClose} size="lg" centered>
                <Modal.Header>
                    <Modal.Title id="contained-modal-title-vcenter">Create test</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form onSubmit={(e) => this.handleTest(e)} ref={(c) => (this.form = c)}>
